...
public abstract class VerticleBase extends Verticle {
    ...
    public static String getVerticleName(Class<? extends VerticleBase> clazz) {
        return clazz.getName();
    }

    public abstract void onStart(Future<Void> startedResult) throws RuntimeException;
    ...
    protected void ready(Future<Void> startedResult) {
